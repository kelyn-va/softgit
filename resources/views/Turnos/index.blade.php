...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
        ...
        <a href="{{route('turno.create')}}" class="crearBtn">
            <i class="bi bi-plus-circle"></i> Crear turnos</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                <a href="{{route('turno.edit', $Turno->id)}}" class="btnActualizar d-flex gap-2 align-items-center">
                                    <i class="bi bi-pencil-square"></i> Actualizar
                                </a>

                                <form action="{{route('turno.destroy', $Turno->id)}}" method="POST" onclick="confirmarEliminacion(event)">
                                    @csrf
