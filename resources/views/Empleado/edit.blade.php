                    ...
                    <form action="{{ route('empleados.update',$empleados->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nombre" name="nombre" 
                                class="form-control @error('nombre') is-invalid @enderror" value="{{ $empleados->nombre }}">
                            @error('nombre')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="cargo" name="cargo" 
                                class="form-control @error('cargo') is-invalid @enderror" value="{{ $empleados->cargo }}">
                            @error('cargo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="usuario" name="usuario" 
                                class="form-control @error('usuario') is-invalid @enderror" value="{{ $empleados->usuario }}">
                            @error('usuario')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="contraseña" name="contraseña" 
                                class="form-control @error('contraseña') is-invalid @enderror" value="{{ $empleados->contraseña }}">
                            @error('contraseña')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="idTurno" name="idTurno" 
                                class="form-control @error('idTurno') is-invalid @enderror" value="{{ $empleados->idTurno }}">
                            @error('idTurno')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
