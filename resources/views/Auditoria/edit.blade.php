...
<h1 class="text-center my-4 fw-bold text-dark">Editar Auditoría</h1>
@endsection
                ...
                <form action="{{ route('Auditoria.update', $auditoria->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="Accion" name="Accion"
                            ...
                            value="{{ old('Accion', $auditoria->Accion) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="fecha" name="fecha"
                            ...
                            value="{{ old('fecha', $auditoria->fecha) }}">
                        @error('fecha')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="cierreCaja" name="cierreCaja"
                            ...
                            value="{{ old('cierreCaja', $auditoria->cierreCaja) }}"
                    ...
                    <div class="text-end">
                        <button type="submit" class="crearBtn">
                            <i class="bi bi-pencil-square"></i> Actualizar Auditoría
                        </button>
                    </div>
                </form>
