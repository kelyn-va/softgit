...
@section('titleContent')
    <h1 class="text-center my-4 fw-bold text-dark">Actualizar Categoria</h1>
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <div class="mb-3 text-start">
                <a href="{{ route('categorias.index') }}" class="volverBtn d-inline-flex align-items-center gap-1">
                    ...
                    <form action="{{ route('categorias.update',$categorias->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nombre" name="nombre" 
                                class="form-control @error('nombre') is-invalid @enderror" value="{{ $categorias->nombre }}">
                            @error('Nombre')
