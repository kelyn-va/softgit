...
@section('title', 'Registrar Detalle de Venta')

@section('titleContent')
    <h1 class="text-center my-4 fw-bold text-dark">Registrar Detalle de Venta</h1>
@endsection
                ...
                <form action="{{ route('DetalleVenta.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="cantidad" name="cantidad"
                            ...
                            value="{{ old('cantidad') }}" placeholder="Ejemplo: 2">
                        @error('cantidad')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="precio_unitario" name="precio_unitario"
                            ...
                            value="{{ old('precio_unitario') }}" placeholder="Ejemplo: 25000.00">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="subtotal" name="subtotal"
                            ...
                            value="{{ old('subtotal') }}" placeholder="Ejemplo: 50000.00">
                        @error('subtotal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="crearBtn">
                            <i class="bi bi-plus-circle"></i> Registrar Detalle
                        </button>
                    </div>
                </form>
