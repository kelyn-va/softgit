...
@section('title', 'Actializar Proveedor')
                    ...
                    <form action="{{route('proveedor.update',$Proveedor->id)}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nombre" name="nombre" 
                                   class="form-control @error('nombre') is-invalid @enderror" value="{{$Proveedor->nombre}}">
                            @error('nombre')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="contacto" name="contacto" 
                                   class="form-control @error('contacto') is-invalid @enderror" value="{{$Proveedor->contacto}}">
                            @error('contacto')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="telefono" name="telefono" 
                                   class="form-control @error('telefono') is-invalid @enderror" value="{{$Proveedor->telefono}}">
                            @error('telefono')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="direccion" name="direccion" 
                                   class="form-control @error('direccion') is-invalid @enderror" value="{{$Proveedor->direccion}}">
                            @error('Direccion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
